...
const Contact = () => {
  ...
  return (
    <div
      name="contact"
      className={`relative z-10 min-h-screen w-full overflow-hidden py-20 md:py-24 ${
        isDarkMode ? "bg-transparent text-white" : "bg-transparent text-gray-900"
      }`}
      ref={ref}
    >
      <div className="relative z-10 mx-auto flex max-w-screen-lg flex-col justify-center p-4">
        <motion.div
